...
- A **interpolação de strings** permite construir uma string que contém valores de variáveis ou expressões.
...
```python
computador = "papel"
mensagem = f'O computador escolheu: {computador}' #=> O computador escolheu: papel
