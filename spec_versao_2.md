...
Nesta versão, o jogo permite muitas rodadas e mantém o placar de vitórias.
...
| pedra | tesoura | Jogador | "Você ganhou esta rodada!" |
| pedra | papel | Computador | "O computador ganhou esta rodada!" |
| papel | pedra | Jogador | "Você ganhou esta rodada!" |
| papel | tesoura | Computador | "O computador ganhou esta rodada!" |
| tesoura | papel | Jogador | "Você ganhou esta rodada!" |
| tesoura | pedra | Computador | "O computador ganhou esta rodada!" |
...
|---|---|---|---|---|
| TC-01 | Fluxo Normal (Vitoria) | "tesoura" | "papel" | Exibe vitória do jogador e soma +1 no placar dele. |
| TC-02 | Fluxo Normal (Derrota) | "papel" | "tesoura" | Exibe vitória do computador e soma +1 no placar dele. |
| TC-03 | Fluxo Normal (Empate) | "pedra" | "pedra" | Exibe mensagem de empate. Placar não se altera. |
| TC-04 | Caixa Alta (Normalização) | "PEDRA" | "tesoura" | Converte para "pedra". Registra vitória do jogador. |
| TC-05 | Espaços em Branco | " pedra " | "tesoura" | Remove espaços (.strip()). Registra vitória do jogador. |
...
* Robustez: Entradas inválidas não podem quebrar ou fechar o programa de forma abrupta; o sistema deve exibir uma mensagem de erro amigável: o sistema deve exibir uma mensagem de erro amigável e solicitar uma nova jogada.
